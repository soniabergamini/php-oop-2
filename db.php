...
$products = [
    ...
    new Toy('Mini Bone', 19, '/img/minibone.webp', new Category('dog', 'Special Products for Special Dogs', '/img/dog.png'), 'ForDogs', 'Puppy'),
...
// Set Kennel Products Properties to prevent php *uninitialized* value
